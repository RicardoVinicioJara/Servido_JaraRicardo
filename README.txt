...
a persistence unit "Servido_JaraRicardoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Servido_JaraRicardo\pom.xml":
...
artifact ("Servido_JaraRicardo.war") is already built. You can build
